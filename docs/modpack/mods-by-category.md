...
Silent Gear (+ JEI), Silent's Gems, Silent Lib, Simply Swords, Simply More, Simplest Paxels, Apothic Attributes, Apothic Enchanting, Artifacts, Mob Grinding Utils, Pylons
...
Macaw's (Bridges, Doors, Fences, Furniture, Holidays, Paths, Roofs, Stairs, Trapdoors, Windows), MrCrayfish Refurbished Furniture, FramedBlocks, Chipped, Rechiseled (+ Chipped), BetterBlockZ, AstikorCarts Redux, OpenBlocks Elevator
...
Plasmo Voice, FTB Teams, Emotecraft, Corpse, PlayerRevive

## Performance

Sodium (+ Extra, Reese's Options, Options API), Lithium, FerriteCore, ModernFix, Entity Culling, Dynamic FPS, Spark, ServerCore, Structure Layout Optimizer, Chunky
...
Architectury, Balm, Bookshelf, Cloth Config, CodeChicken Lib, CreativeCore, Cucumber, Curios, Cyclops Core, Framework, GeckoLib, Glodium, Lodestone, Lionfish API, McJtyLib, Moonlight, Modonomicon, Patchouli, Placebo, Prickle, Puzzles Lib, Resourceful Lib/Config, SmartBrainLib, SuperMartijn642 Core/Config, Titanium, ZeroCore 2, Athena, Fzzy Config, Kotlin for Forge, Citadel, playerAnimator, Target Dummy (dummmmmmy)

## Pacotes fora de `mods/`

| Pacote | Tipo |
|--------|------|
| The Brazilian Project [1.21.1-1.3.0].zip | Resource pack PT-BR |
| ComplementaryReimagined_r5.8.1.zip | Shader |
| ComplementaryUnbound_r5.8.1.zip | Shader |
| Bliss_v2.1.2_(Chocapic13_Shaders_edit).zip | Shader |
| Photon Shader | Shader |
| Sildur's Vibrant Shaders v1.56 Extreme.zip | Shader |
